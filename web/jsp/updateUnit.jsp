...
<body>
<div class="x-body">
    <form class="layui-form" action="${pageContext.request.contextPath}/updateUnit" method="post">
        <input type="hidden" name="unitAccNum" value="${unitAccNum}">
        <div class="layui-form-item">
            <label for="unitAccName" class="layui-form-label">
                <span class="x-red">*</span>单位名称
            </label>
            <div class="layui-input-inline">
                <input type="text" id="unitAccName" name="unitAccName" value="${unit.unitAccName}"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="unitKind">
                        ...
                        <c:forEach items="${unitKind}" var="unitKind">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="unitAddress" name="unitAddress" value="${unit.unitAddress}" required
